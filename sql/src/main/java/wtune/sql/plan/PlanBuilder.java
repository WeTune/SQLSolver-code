...
import wtune.sql.ast.constants.SetOpOption;
...
import static wtune.common.utils.Commons.dumpException;
import static wtune.common.utils.SetSupport.map;
import static wtune.sql.SqlSupport.selectItemNameOf;
import static wtune.sql.ast.constants.BinaryOpKind.AND;
import static wtune.sql.ast.constants.BinaryOpKind.IN_SUBQUERY;
import static wtune.sql.plan.PlanSupport.FAILURE_INVALID_PLAN;
