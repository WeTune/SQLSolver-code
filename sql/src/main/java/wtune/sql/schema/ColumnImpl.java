...
import static wtune.sql.schema.Column.Flag.*;
...
class ColumnImpl implements Column {
  ...
  static ColumnImpl build(String table, SqlNode colDef) {
    final String colName = simpleName(colDef.$(SqlNodeFields.ColDef_Name).$(SqlNodeFields.ColName_Col));
    ...
    if (colDef.isFlag(SqlNodeFields.ColDef_Generated)) column.flag(GENERATED);
    if (colDef.isFlag(SqlNodeFields.ColDef_Default)) column.flag(HAS_DEFAULT);
    if (colDef.isFlag(SqlNodeFields.ColDef_AutoInc)) column.flag(AUTO_INCREMENT);
