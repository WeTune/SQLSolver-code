...
import static wtune.sql.support.resolution.ParamModifier.Type.LIMIT_VAL;
import static wtune.sql.support.resolution.ParamModifier.Type.OFFSET_VAL;
import static wtune.sql.support.resolution.ParamModifier.modifier;
