...
import static wtune.superopt.logic.LogicSupport.PROVER_DISABLE_INTEGRITY_CONSTRAINTS_THEOREM;
import static wtune.superopt.logic.LogicSupport.UNKNOWN;
...
//      e.printStackTrace();
  ...
  private int proveEq0NotNeedLia(UTerm exp1, UTerm exp2) throws Exception {
