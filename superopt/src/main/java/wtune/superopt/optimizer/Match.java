...
import static wtune.common.utils.ListSupport.linkedListFlatMap;
import static wtune.sql.ast.ExprKind.Aggregate;
import static wtune.sql.ast.ExprKind.ColRef;
import static wtune.sql.ast.SqlNodeFields.GroupItem_Expr;
import static wtune.sql.plan.PlanSupport.joinKindOf;
import static wtune.sql.plan.PlanSupport.locateNode;
